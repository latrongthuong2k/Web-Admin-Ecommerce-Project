                        ...
                        <div className="">
                            ...
                            <div className="mt-6 space-y-4 px-[30px] py-[35px] ">
                                ...
                                <a
                                    ...
                                    className="block rounded-[50px] border-gray-500 bg-red-500 px-4 py-2 text-center text-white hover:bg-red-600"
                                >
                                    Login with Google
                                </a>
                                <a
                                    href={"http://localhost:8080/oauth2/authorization/google"}
                                    className="block rounded-[50px] border-gray-500 bg-gray-700 px-4 py-2 text-center text-white hover:bg-gray-900"
                                >
                                    Login with GitHub
                                </a>
                            </div>
